                                    ...
                                    <tbody>
                                      ...
                                      <tr>
                                        <td style="padding: 0 0 10px 0; font-size: 14px; line-height: 150%; font-weight: 400; color: #000000; letter-spacing: 0.01em;">
                                          Thanks for choosing Authentication! We are happy to see you on board.
                                        </td>
                                      </tr>
                                      <tr>
                                      ...
                                      <tr>
                                        <td style="padding: 0 0 24px 0;">
                                          <a class="button" href="${process.env.DOMAIN
                                          }/verifyemail?token=${hashedToken}" title="Verify Email" style="width: 100%; background: #4C83EE; text-decoration: none; display: inline-block; padding: 10px 0; color: #fff; font-size: 14px; line-height: 21px; text-align: center; font-weight: bold; border-radius: 7px;">Verify Email</a>
                                        </td>
                                      </tr>                             
                                      <tr>
                                      <tr>
                                      ...
                                      <tr>
                                        <td style="font-size: 14px; line-height: 170%; font-weight: 400; color: #000000; letter-spacing: 0.01em;">
                                          Best regards, <br><strong>Authentication</strong>
                                        </td>
                                      </tr>
                                    </tbody>
                                  </table>
                              ...
                              <tr>
                                <td style="padding: 24px 0 48px; font-size: 0px;">
                                  ...
                                  <div class="outlook-group-fix" style="padding: 0 0 20px 0; vertical-align: top; display: inline-block; text-align: center; width:100%;">
                                    <span style="padding: 0; font-size: 11px; line-height: 15px; font-weight: normal; color: #8B949F;">Authentication<br/>
                                    </div>
                                  </div>
                                ...
                                <td class="main-content" style="padding: 48px 30px 40px; color: #000000;" bgcolor="#ffffff">
                                  <table width="100%" cellspacing="0" cellpadding="0" border="0">
                                    <tbody>
                                      ...
                                      <tr>
                                        <td style="padding: 0 0 24px 0;">
                                          <a class="button" href="${process.env.DOMAIN}/resetpassword?token=${hashedToken}" title="Reset Password" style="width: 100%; background: #22D172; text-decoration: none; display: inline-block; padding: 10px 0; color: #fff; font-size: 14px; line-height: 21px; text-align: center; font-weight: bold; border-radius: 7px;">Reset Password</a>
                                        </td>
                                      </tr>
                                      <tr>
                                        <td style="padding: 0 0 10px 0; font-size: 14px; line-height: 150%; font-weight: 400; color: #000000; letter-spacing: 0.01em;">
                                      ...
                                      <tr>
                                        <td style="padding: 0 0 60px 0; font-size: 14px; line-height: 150%; font-weight: 400; color: #000000; letter-spacing: 0.01em;">
                                          If you didn’t request the password reset, please ignore this message or contact our support at <a href="mailto:authsupport@gmail.com">authsupport@gmail.com</a>.
                                        </td>
                                      </tr>
                                      <tr>
                                        <td style="padding: 0 0 16px;">
